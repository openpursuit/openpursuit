...
def channel(request):
    return direct_to_template(request, 'fbapp/channel.html', extra_context={})


def main(request):
    return direct_to_template(request, 'fbapp/main.html', extra_context={})
...
def addquiz(request):
    return direct_to_template(request, 'fbapp/addquiz.html', extra_context={})
