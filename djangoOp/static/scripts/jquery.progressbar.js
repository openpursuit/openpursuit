	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width			: 120,											// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: 'http://www.openpursuit.org/media/img/progressbg_green.gif'
				height			: 12,											// Height of the progressbar - don't forget to adjust your image too!!!
				callback		: null,											// Calls back with the config object that has the current percentage, target percentage, current image, etc
				boxImage		: 'http://www.openpursuit.org/media/img/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'http://www.openpursuit.org/media/img/progressbg_red.gif',
									30: 'http://www.openpursuit.org/media/img/progressbg_orange.gif',
									70: 'http://www.openpursuit.org/media/img/progressbg_green.gif'
								},
